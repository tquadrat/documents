...
Source files with more than 2000~lines are cumbersome and should be avoided.\footnote{I have to confess that the number~2000 is just a ballpark figure; set a different value if you like.} Nevertheless, there are some well known scenarios where it is difficult to adhere with this limit.

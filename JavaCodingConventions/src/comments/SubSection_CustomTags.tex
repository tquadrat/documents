...
Next you need to register each Taglet implementation with the option \mbox{\texttt{-tagletclass}} (one entry per class).
...
The command line for this would look like this:
\keeplisting{20}
\begin{lstlisting}

...
I already mentioned the single-letter variable \lstinline|e| that is used for the caught exception in a catch block.

\keeplisting{18}
The variable \lstinline|retValue| is reserved for the return value of a method\index{method}; basically a method\index{method} that does not have \lstinline|void| as the return value will return always \lstinline|retValue|, \lstinline|this| or an attribute:
\begin{lstlisting}

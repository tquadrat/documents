...
\keeplisting{16}
In case you declare a field only to provide the monitor for synchronisation, you should name it as `\verb#Guard#’\index{guard object}.
\begin{lstlisting}
...
If that field exists only for this purpose, it should be named accordingly, as `\verb#Guard#’\index{guard object}.}

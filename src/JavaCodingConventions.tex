...
This means, you will usually use \lstinline|Collection|\index{java.util!Collection} or \lstinline|List|\index{java.util!List} instead of \lstinline|LinkedList|\index{java.util!LinkedList}, and \lstinline|OutputStream|\index{java.io!OutputStream} instead of \lstinline|ByteArrayOutputStream|\autocite{ORACLE_DOC_BYTEARRAYOUTPUTSTREAM_CLASS}\index{java.io!ByteArrayOutputStream}.

One difference is in regard of methods returning strings: here you should \textit{not} use \lstinline|CharSequence|\index{java.lang!CharSequence}! In nearly all cases where a method returns a string this value will be an instance of \lstinline|java.lang.String|\autocite{ORACLE_DOC_STRING_CLASS}\index{java.lang.String} anyway – not to mention that \lstinline|String|\index{java.lang.String} implements \lstinline|CharSequence|\index{java.lang.CharSequence}.
...
, but different from the return types, you should always to consider to use \lstinline|java.lang.CharSequence| instead of \lstinline|java.lang.String|.

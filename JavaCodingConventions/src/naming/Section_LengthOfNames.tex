...
The \bdq{The \Java Language Specification} does not impose a length limit for names of program elements: \bdq{An \textit{identifier} is an unlimited-length sequence of \textit{Java letters} and \textit{Java digits}, the first of which must be a \textit{Java letter}.} \autocite{ORACLE_DOC_LANGUAGE_SPECIFICATION:Identifiers}

...
\keeplisting{14}
A \lstinline|switch| statement\index{switch!statement} for the \bdq{\texttt{case L:}} variant would look like this:
\index{switch!case}\index{switch!default}\index{switch!break}
\begin{lstlisting}
var selector = <anObject>
switch( selector )
{
    case <class1> <name1>: <singleStatement>; break;
    ...
    default: <singleStatement>; break;
}
\end{lstlisting}

\keeplisting{15}
For the \bdq{\texttt{case L->}} variant, a \lstinline|switch| statement\index{switch!statement} is written as below:
...
\keeplisting{16}
And a \bdq{\texttt{case L->}} variant \lstinline|switch| expression\index{switch!expression} would have this form:

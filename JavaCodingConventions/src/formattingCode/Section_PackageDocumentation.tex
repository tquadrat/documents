...
Originally a file named \texttt{package.html}\index{package.html|see {package-info.java}} was used; it contained an HTML\index{HTML} document with the package documentation. Although this still works, you should use not use it anymore, because it does not allow to set annotations on package level. 

The \texttt{<package description>} is a standard Javadoc comment\index{javadoc} (refer to the chapter \tqfullref{sec:DocumentationComments}) and can be as lengthy as necessary. It will be discussed in detail in chapter \tqfullvref{sec:PackageComment}.

...
Each Java source file\footnote{… or \bdq{ordinary compilation unit}\index{compilation unit!ordinary}} contains at least one top level class or interface declaration; in most cases, it is just one. And it is strongly discouraged that it would be more than one!
...
Records can have inner classes, but in the same was as for \lstinline|enum|s, this is also discouraged, and there is no use case for it.

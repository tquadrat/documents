...
A lambda expression with more than one argument should be written like this, according to the rules above:
\begin{lstlisting}
...
final BiFunction f3 = (_,_) -> PI;
\end{lstlisting}
is better readable, at least for single-letter parameter names or the unnamed variable\index{unnamed variable} (the underscore that is provided instead of the parameter).

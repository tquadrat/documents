...
For the process mode set to \bdq{\texttt{PLAIN}} the output looks like this: 
\begin{center}
	\includegraphics[scale=0.55]{comments/JavadocIncludePlain}
\end{center}
For \bdq{\texttt{ESCAPE}} it is rendered like this: 
\begin{center}
	\includegraphics[scale=0.55]{comments/JavadocIncludeEscape}
\end{center}
And the process mode \bdq{\texttt{SOURCE}} results as below: 
\begin{center}
	\includegraphics[scale=0.55]{comments/JavadocIncludeSource}
\end{center}

The location of the folder indicated by \bdq{\texttt{\$\{includes\}}} was specified by the system property \bdq{\texttt{org.tquadrat.foundation.include.root.includes}}.

...
\textbf{Note:} Sample code for the use in documentations, articles or alike should have a limited line length – generally not more than 70~characters.
...
Some APIs are designed to allow “method chaining”, sometimes also referred as “Call Chaining”; you may find this in particular on implementations of the “builder” pattern, but it appears elsewhere, too. A prominent example is the class \lstinline|java.lang.StringBuilder|\autocite{ORACLE_DOC_STRINGBUILDER_CLASS} (obviously not a builder), an example for a builder class would be the class \lstinline|java.time.format.DateTimeFormatterBuilder|\autocite{ORACLE_DOC_DATETIMEFORMATTERBUILDER_CLASS}.
...
You encounter this situation mostly when your method takes a collection type as an argument: should it be \lstinline|myMethod( Collection<String> )| or \lstinline|myMethod( final ArrayList<String> )|?

Another class hierarchy that raises this question is build around \lstinline|InputStream| and \lstinline|OutputStream|.

A similar situation is there about \lstinline|String| and \lstinline|CharSequence|.

...
Some sources (e.g. \autocite{ORACLE_DOC_SWITCHEXPRESSIONS}) refer to the different syntax variants by the form of the \lstinline|switch|\index{switch} labels as \bdq{\texttt{case L:}} (\bsq{old}) and \bdq{\texttt{case L ->}} (\bsq{new}). 

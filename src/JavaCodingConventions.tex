...
The loggers can be configured to only log message with at least a certain priority or \textit{log level}. For the JDK Logging, Log4J and SLF4J, the predefined log levels differ:
...
My recommendation would be to completely ignore the log level \verb#CONFIG# and to use a dedicated logger with log level \verb#INFO# instead.

...
Looking a the code to write, all three work basically the same:
\begin{enumerate}[nosep]
...
\begin{filecontents}{LogLevels.tbl}
  ...
  \hline 
  \verb#WARNING# & \verb#WARN# & \verb#WARN# & An event that might possible lead to an error. \\ 
  \hline 
...
So when you should log something? And what should you log?

First, you should log error conditions. Usually this means that you will log an exception. And you will log an exception only when you do not further delegate the handling of that exception. For tools and standalone applications, this means that you will log an exception latest in the \lstinline|main()| method.

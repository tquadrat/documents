...
According to \bdq{The \Java Language Specification}  \autocite{ORACLE_DOC_LANGUAGE_SPECIFICATION:CompilationUnit} does each (ordinary) compilation unit\index{compilation unit} consist of three parts, each of which is optional:

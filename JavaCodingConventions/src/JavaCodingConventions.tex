...
\item{For ORM\index{ORM}: JPA\index{JPA} \autocite{IBM_JPA, ECLIPSE_JPA} and Hibernate\index{Hibernate} \autocite{HIBERNATE_ORM}}
\item{For command line handling: ARGS4J\index{ARGS4J} \autocite{Kawaguchi:args4j, Kawaguchi:args4j_github}}
\end{itemize}

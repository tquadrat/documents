...
As said, you find the sources for this document on GitHub\index{GitHub}. Clone the repository on GitHub \autocite{TQUADRAT_ORG_DOCUMENT_REPOSITORY}, replace the examples and the references to my libraries by some that fits better to your project and/or your company, then adjust the other stuff accordingly.

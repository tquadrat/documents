...
One motiviation for the JEPs had been the error prone syntax of the original “\verb#case L:#” \lstinline|switch| statement; this is fixed by the new “\verb#case L ->#”form – but only when it is used.}

...
\begin{itemize}[nosep]
	...
	\item{Trailing or end-of-line Comments\index{trailing comment}}
\end{itemize}
...
\keeplisting{2}
A trailing comment is technically a single-line comment that is placed after a statement in the same line:
\begin{lstlisting}

...
Of course this can be changed; chapter \tqvref{sec:ExceptionHandlingInThreads} describes how this is done.}
\end{itemize}
...
You should absolutely avoid to catch \lstinline|java.lang.Error| and all its subclasses, \lstinline|java.lang.RuntimeException|, and of course, you should not never ever catch \lstinline|java.lang.Throwable|!\footnote{But no rule without an exception: refer to chapter \tqvref{sec:ExceptionHandlingInThreads}.}

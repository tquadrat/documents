...
First of all, you should avoid to use Reflection\index{reflection} whenever possible. Just do not use it!\footnote{The only acceptable exception is for unit tests\index{unit test}; we will discuss that later in this chapter.}

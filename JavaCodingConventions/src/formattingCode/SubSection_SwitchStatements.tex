...
Some sources (e.g. \autocite{ORACLE_DOC_SWITCHEXPRESSIONS}) refer to the different syntax variants by the form of the \lstinline|switch| labels as ``\verb#case L:#'' (\bsq{old}) and ``\verb#case L ->#'' (\bsq{new}). 

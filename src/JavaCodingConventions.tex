...
public Person( final String id, final String lastName, final String firstName, final String... contactIds )
{
    ...
    var counter = 0;
    for( final var contactId : requiredNonNullArgument( contactIds, "contactIds" ) )
    {
...
Per \autocite{ORACLE_DOC_OBJECT:clone}, the method \lstinline|java.lang.Object::clone|\index{java.lang!Object!clone()} returns a copy of the current object.

Usually, this method is \lstinline|protected| and the default implementation throws a \lstinline|java.lang.CloneNotSupportedException|\autocite{ORACLE_DOC_CLONENOTSUPPORTEDEXCEPTION_CLASS}\index{java.lang!CloneNotSupportedException} when called.

When instances of your class should support to be cloned, it first has to implement the interface \lstinline|java.lang.Cloneable|\autocite{ORACLE_DOC_CLONEABLE_INTERFACE}\index{java.lang!Cloneable}, and then you need to override the method \lstinline|clone()|\index{java.lang!Object!clone()}.

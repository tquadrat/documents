...
Constants\index{constant} in Java are fields of primitive or immutable types\index{immutable type} that are declared as \lstinline|public static final|. According to the \ccjpl, their names ``should be all uppercase with words separated by underscores (`\verb#_#')'' \autocite{SUN_CODE_CONVENTIONS:NamingConventions}.

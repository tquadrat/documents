...
Next, usually several \lstinline|import| statements will follow\footnote{Only very basic code will not import other stuff than that from the \lstinline|java.lang|\index{java.lang} package; a sample for that are marker interfaces.}. 

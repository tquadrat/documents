\section{The File Structure}\label{sec:FileStructure}

According to \jls \autocite{ORACLE_DOC_LANGUAGE_SPECIFICATION:CompilationUnit} does each (ordinary) compilation unit\index{compilation unit} consist of three parts, each of which is optional:
...
\input{formattingCode/SubSection_ClosingComment}

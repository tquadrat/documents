...
\jls distinguishes between \bdq{Ordinary Compilation Units}\index{compilation unit!ordinary}, \bdq{Compact Compilation Units}\index{compilation unit!compact} and \bdq{Modular Compilation Units}\index{compilation unit!modular}. Here, we are only interested in the \bdq{Ordinary Compilation Units}\index{compilation unit!ordinary}.

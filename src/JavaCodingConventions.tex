...
A “listener” class may look like this:
\begin{lstlisting}
...
And the “event source” class could be this:
\begin{lstlisting}
...
But although this works, for the listener pattern you should prefer the first approach. For other cases, the last one is a good alternative to the use of Reflection\index{reflection}.

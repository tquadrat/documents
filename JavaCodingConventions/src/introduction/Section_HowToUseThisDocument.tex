	...
	In no particular order:
		...
		\item{Chapter \tqfullvref{sec:TheNamingDictionary}:
		    \begin{itemize}
		    	...
		    	\item{Add a Glossary that explains special terms used in the context of your project (the \bdq{Domain Specific Terminology}). Chapter \tqfullvref{sec:DomainVocabulary} is a placeholder for that.}
	    \end{itemize}}

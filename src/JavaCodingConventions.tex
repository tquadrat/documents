...
Use of \lstinline|var| here removes the noisy type declarations for the local variables. Having explicit types for the \lstinline|Iterator|\index{java.util!Iterator} and \lstinline|Map.Entry|\autocite{ORACLE_DOC_MAP.ENTRY_INTERFACE}\index{java.util!Map.Entry} locals in this kind of loop is largely unnecessary. This also allows the \lstinline|for|-loop control to fit on a single line, further improving readability.
\index{java.util!Map}\index{java.util!Map!entrySet()}\index{java.util!Map.Entry}\index{java.util!Set!iterator()}\index{java.util!Iterator}\index{java.util!Iterator!remove()}\index{java.lang!Number}
\begin{lstlisting}
// GOOD
public final void removeMatches( final Map<? extends String,? extends Number> map, final int max ) 

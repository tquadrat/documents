...
A return statement is always the last statement of a method – and there are never ever more than one return statement in a method:
 if the method does not return a field. Returning an expression or a field is also acceptable. If in doubt, prefer assigning the expression's value to retValue and return that. Try to make the structure of your program match the intent.
...
\begin{lstlisting}
// RECOMMENDED
boolean retValue = <booleanExpression>;
return retValue;

\subsection{Blank Spaces}\label{BlankSpaces}The principles below are in place regarding the use of blank spaces, above and beyond to what was said already.
...
\item{All binary operators except \bdq{\lstinline|.|} has to be separated from their operands by spaces.
...
\item{Blank spaces should never separate unary operators such as unary minus, increment (\bdq{\lstinline|++|}), and decrement (\bdq{\lstinline|--|}) from their operands.

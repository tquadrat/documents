\section{How to use this Book}\label{sec:HowToUseThisDocument}
First, you can use this book as is! It should work for you, as its predecessors already worked for a bunch of project teams before.
...
As said, you find the sources for this book on GitHub\index{GitHub}. Clone the repository on GitHub \autocite{TQUADRAT_ORG_DOCUMENT_REPOSITORY}, replace the examples and the references to my libraries by something that fits better to your project and/or your company, then adjust the other stuff accordingly.
	...
	In no particular order:
		...
		\item{Chapter \tqfullvref{sec:TheNamingDictionary}:
		    \begin{itemize}
		    	...
		    	\item{Add a Glossary that explains special terms used in the context of your project (the \bdq{Domain Specific Terminology} or \bdq{Ubiquitous Language}). Chapter \tqfullvref{sec:DomainVocabulary} is a placeholder for that.}
	    \end{itemize}}
...
At this point, it is a good place to repeat the license that governs the publishing of this book:

...
Usually, all modules\index{module} on the module source path are documented. But if required (e.g. for a documentation targeted to an external audience) the modules\index{module} that should be part of the generated documentation can be explicitly listed with the command line option \mbox{\bsq{\texttt{-{}-module}}}; that allows to omit purely internal modules\index{module}.

The \mbox{\bsq{\texttt{-version}}} option controls that the \bdq{\nameref{sec:TagVersion}} tags are included into the generated documentation.

...
Each Java source file\footnote{… or compilation unit\index{compilation unit}} contains at least one top level class or interface declaration; in most cases, it is just one. And it is strongly discouraged that it would be more than one!
